...
<template>
    <table class="w-full whitespace-nowrap">
        ...
        <tbody>
            <tr v-for="user in users" class="mb-6">
                <td class="">
                ...
                <!-- <td :vi-if="$route.name === 'moderators'" class="pl-5">
                    <div class="flex items-center">
                ...
                <td v-if="user.role === UserRole.MANAGER" class="pl-5" :vi-if="$route.name.toString() === 'stores'" >
                    <div class="flex items-center">

...
<template>
    <div class="relative px-5 pt-2">
        <button class="focus:ring-2 rounded-md focus:outline-none" @click="show===false ? show = true : show = false" role="button" aria-label="option">
        ...
        <div class="dropdown-content bg-white shadow w-24 absolute z-30 right-0 mr-6" v-if="show">
